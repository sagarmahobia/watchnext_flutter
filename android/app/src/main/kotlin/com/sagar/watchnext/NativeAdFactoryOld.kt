...
internal class NativeAdFactoryOld(private val layoutInflater: LayoutInflater) :
    NativeAdFactory {
   override fun createNativeAd(nativeAd: NativeAd, customOptions: Map<String?, Any?>?): NativeAdView {
        val adView: NativeAdView =
            layoutInflater.inflate(R.layout.old_native_ad, null) as NativeAdView

        // Set the media view.
       adView.mediaView = adView.findViewById(R.id.media_view) as MediaView
