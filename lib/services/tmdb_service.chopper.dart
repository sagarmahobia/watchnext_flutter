...
class _$TMDBService extends TMDBService {
  ...
  @override
  Future<Response<People>> getPeople(String url,
      {int page = 1, String query = ""}) {
    final $url = 'https://api.themoviedb.org/3/${url}';
    final $params = <String, dynamic>{'page': page, 'query': query};
    final $request = Request('GET', $url, client.baseUrl, parameters: $params);
  ...
  Future<Response<MovieDetail>> getMovieDetails(int id) {
    final $url =
        'https://api.themoviedb.org/3/movie/${id}?append_to_response=similar,recommendations,credits,videos';
    final $request = Request('GET', $url, client.baseUrl);
  ...
  Future<Response<TvDetail>> getTvDetails(int id) {
    final $url =
        'https://api.themoviedb.org/3/tv/${id}?append_to_response=similar,recommendations,credits,videos';
    final $request = Request('GET', $url, client.baseUrl);
  ...
  Future<Response<PersonDetail>> getPersonDetail(int personId) {
    final $url =
        'https://api.themoviedb.org/3/person/${personId}?append_to_response=movie_credits,tv_credits';
    final $request = Request('GET', $url, client.baseUrl);
  ...
  Future<Response<CollectionDetailModel>> getCollection(int id) {
    final $url = 'https://api.themoviedb.org/3//collection/${id}';
    final $request = Request('GET', $url, client.baseUrl);
